...
function processBlockswapConfig() {
    ...
    let swapperObj = {}
    BLOCKSWAP_CONFIG.swapper.forEach((value, key, map) => {
    ...
    BLOCKSWAP_CONFIG.swapper = swapperObj

    JsonIO.write('config/blockswap/block_swap.json5', BLOCKSWAP_CONFIG)
}