    ...
    Object.keys(woodTypesToConstruct).forEach(mod => {
        ...
        Object.keys(woodTypesToConstruct[mod]).forEach(woodType => {
            ...
            const woodTypeObj = {
                ...
                quark_ladder:           quarkCompatId + woodType + '_ladder',  // TEMPORARY; deleted later
                quark_chest:            quarkCompatId + woodType + '_chest',  // TEMPORARY; deleted later
                quark_trapped_chest:    quarkCompatId + woodType + '_trapped_chest',  // TEMPORARY; deleted later
                quark_bookshelf:        quarkCompatId + woodType + '_bookshelf',  // TEMPORARY; deleted later
                // Create
            ...
            if (woodTypesToConstruct[mod][woodType]) {
                ...
                delete woodTypeObj.quark_ladder,
                delete woodTypeObj.quark_chest,
                delete woodTypeObj.quark_trapped_chest,
                delete woodTypeObj.quark_bookshelf,
